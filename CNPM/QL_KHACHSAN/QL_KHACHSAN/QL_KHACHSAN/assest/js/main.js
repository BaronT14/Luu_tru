...
function layDiaDiem() {
    var show_diadiem = document.getElementById('show-place');
...
function layLoc() {
    document.querySelector('.box-search__search-btn').onclick = function () {
        var dd = document.getElementById('show-place').innerHTML;
        var gia = document.getElementById('show-price').innerHTML;
        window.location = "/Tour/HienThiTour_Loc?diadiem=" + dd + "&gia=" + gia;
    }
}